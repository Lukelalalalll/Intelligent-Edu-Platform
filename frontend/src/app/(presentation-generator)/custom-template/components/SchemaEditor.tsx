    ...
    const scrollToField = useCallback((path: string) => {
        ...
        setTimeout(() => {
            ...
            if (fieldEl) {
                ...
                fieldEl.classList.add('ring-2', 'ring-[var(--primary-color,#007B55)]', 'ring-offset-2');
                setTimeout(() => {
                    fieldEl.classList.remove('ring-2', 'ring-[var(--primary-color,#007B55)]', 'ring-offset-2');
                }, 2000);
            }
        }, 100);
    }, []);
                        ...
                        <div className="flex items-center justify-between mb-1">
                            ...
                            {fields.length > 0 && (
                                <button
                                    ...
                                    className="text-[10px] font-medium text-gray-400 transition-colors hover:text-[var(--primary-color,#007B55)]"
                                >
                    ...
                    {parseError ? (
                        ...
                        <div className="space-y-1 px-2 ">
                            {hierarchicalFields.map(({ field, children }) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`rounded-md border transition-all my-3 ${isHighlighted
                                                ? 'border-[var(--primary-color,#007B55)] bg-[rgba(0,123,85,0.08)] ring-2 ring-[rgba(0,123,85,0.22)]'
                                                : fModified
                                        ...
                                        >
                                            ...
                                            >
                                                <div className="flex items-center gap-2 min-w-0">
                                                    ...
                                                    {f.type === 'array' && <List className="w-3.5 h-3.5 text-[var(--primary-color,#007B55)] flex-shrink-0" />}
                                                    ...
                                                    {/* Highlight indicator */}
                                                    {isHighlighted && (
                                                        <span className="flex items-center gap-1 rounded bg-[rgba(0,123,85,0.12)] px-1.5 py-0.5 text-[9px] text-[var(--primary-dark,#006644)]">
                                ...
                                // Determine styles based on parent type
                                const isArrayParent = field.type === 'array';
                                const borderColor = isArrayParent ? 'border-[rgba(0,123,85,0.22)]' : 'border-blue-200';
                                const lineColor = isArrayParent ? 'bg-[rgba(0,123,85,0.22)]' : 'bg-blue-200';
                                const textColor = isArrayParent ? 'text-[var(--primary-color,#007B55)]' : 'text-blue-500';
                                const bgColor = isArrayParent ? 'bg-[rgba(0,123,85,0.08)]' : 'bg-blue-50';
                                const badgeTextColor = isArrayParent ? 'text-[var(--primary-dark,#006644)]' : 'text-blue-400';
