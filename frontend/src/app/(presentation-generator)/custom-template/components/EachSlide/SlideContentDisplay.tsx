...
import { RotateCcw, X, AlertCircle, ImageOff, CheckCircle2 } from "lucide-react";
  ...
  if (slide.processed && slide.react && !slide.processing) {
    return (
      <div className="relative flex-1">
        {/* Preview Mode Banner */}
        {previewData && (
          <div className="mb-4 flex items-center justify-between rounded-lg border border-[rgba(0,123,85,0.16)] bg-[rgba(0,123,85,0.08)] px-4 py-3">
            <div className="flex items-center gap-2">
              <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[var(--primary-color,#007B55)]">
                <CheckCircle2 className="h-3.5 w-3.5 text-white" />
              </div>
              <span className="text-sm font-medium text-[var(--primary-color,#007B55)]">
            ...
            {onClearPreview && (
              <Button
                ...
                className="h-8 text-[var(--primary-color,#007B55)] hover:bg-[rgba(0,123,85,0.08)] hover:text-[var(--primary-dark,#006644)]"
              >
