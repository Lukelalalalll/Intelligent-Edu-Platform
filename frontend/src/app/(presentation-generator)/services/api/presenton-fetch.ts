...
type PresentonFetchOptions = RequestInit & {
...
export const presentonFetch = async (
  input: RequestInfo | URL,
  init: PresentonFetchOptions = {}
): Promise<Response> => {
...
export const ensurePresentonSession = async (): Promise<void> => {
  const response = await presentonFetch(SESSION_PATH, {
    method: "GET",
    cache: "no-store",
  });
