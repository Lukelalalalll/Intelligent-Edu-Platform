...
const NewSlideV1 = ({
  ...
  return (
    <div
      ...
      className="relative w-full overflow-hidden rounded-[24px] border border-white/70 bg-[rgba(255,255,255,0.96)] font-syne shadow-[0_28px_90px_rgba(15,23,42,0.18)] backdrop-blur-xl"
    >
      <button
        type="button"
