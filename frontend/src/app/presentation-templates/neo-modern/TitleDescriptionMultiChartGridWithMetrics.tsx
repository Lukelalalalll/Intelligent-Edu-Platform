/**
 * Neo-modern layout: title, description, up to 4 metrics, and 1鈥? charts in a responsive grid.
 */
...
export const layoutDescription = 'A neo-modern dashboard with title, description, up to 4 KPI metrics, and 1鈥? auto-arranged charts. Supports bar (vertical, horizontal, grouped, stacked, clustered, diverging), line, area, pie, donut, and scatter charts.';
