...
import * as api from '../../../api/studyNotesHistoryApi';
            ...
            <div className={s.historyDetailView}>
                <div className={s.historyDetailHeader}>
                    ...
                    <div className={s.historyDetailHeadingBlock}>
                        ...
                        <h4 className={s.historyDetailTitle}>Study Notes Details</h4>
                    </div>
                </div>
    ...
    return (
        <div className={s.historyListView}>
            <div className={s.historyTitleRow}>
                ...
                <div className={s.historyTitleHint}>Recent study notes and flashcard generations</div>
            </div>
