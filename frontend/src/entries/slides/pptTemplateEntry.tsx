...
import PptTemplatePage from '../../features/slides/pages/PptTemplate/PptTemplatePage';
import SlidesLoadingState from '../../features/slides/components/SlidesLoadingState';
import { useSlideTemplateEditor } from '../../features/slides/hooks/useSlideTemplateEditor';
...
export default function PptTemplateEntry() {
    ...
    return <PptTemplatePage states={states} handlers={handlers} />;
}