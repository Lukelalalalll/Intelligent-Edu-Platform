...
import StudyNotes from '../../pages/sub5/StudyNotes';
import styles from '../../styles/sub5/sub5.module.css';
...
export default function StudyNotesEntry() {
    ...
    const handleGenerate = useCallback(async () => {
        ...
        try {
            ...
            const notesRes = await client.post('/sub5/generate-notes', formData, {
            ...
            const flashRes = await client.post('/sub5/generate-flashcards', flashForm, {
                headers: { 'Content-Type': 'multipart/form-data' },
            });
