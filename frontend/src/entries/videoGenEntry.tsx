...
import HistoryPanel from '../features/video-gen/components/HistoryPanel';
import Button from '../shared/components/Button/Button';
import Card from '../shared/components/Card/Card';
import WelcomeBanner from '../shared/components/WelcomeBanner';
import videoStyles from '../features/video-gen/styles/videoGen.module.css';
import s from '../styles/history.module.css';

export default function VideoGenEntry() {
    ...
    return (
        <div className="container">
            ...
            />
            {viewSwitchJSX}
            {activeView === 'workflow' && <VideoGenPage hideBanner />}
            {activeView === 'history' && (
