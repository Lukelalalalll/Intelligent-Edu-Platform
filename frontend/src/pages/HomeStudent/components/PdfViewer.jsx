 ...
 */
const PdfDocBridge = React.memo(function PdfDocBridge({ pdfDocument, onLoad, renderSelectionTip }) {
...
export default function PdfViewer({ file, fileType, onHighlight, onClose, onAddNote, onTextExtracted }) {
                ...
                (entries) => {
                    ...
                    for (const entry of entries) {
                        if (entry.intersectionRatio > bestRatio) {
                            ...
                            const num = Number.parseInt(entry.target.dataset.pageNumber, 10);
                            if (num) bestPage = num;
                        }
                    }
                    if (bestRatio > 0) {
