...
export default function Forgot({
    ...
    return (
        <div className="auth-wrapper forgot-wrapper">
            <div className="bg-orb forgot-orb"></div>
            <div className="auth-container">
                <div className="auth-card" id="forgotCard">
                    ...
                    <form className="auth-form" onSubmit={handleSubmit}>
                        ...
                        {[
                            { name: 'newPassword', label: 'New Password', show: showNewPassword, setShow: setShowNewPassword },
                            ...
                            <div className="input-group" key={field.name}>
                                ...
                                <input
                                    type={field.show ? "text" : "password"} id={field.name} name={field.name} placeholder=" " required
                                    value={formData[field.name]} onChange={handleChange}
                                />
                        ...
                        <button type="submit" className={`btn-submit ${loading ? 'loading' : ''}`} disabled={loading}>
                            {loading ? <><i className="fas fa-circle-notch fa-spin"></i> Updating...</> : <><span>Update Password</span><i className="fas fa-arrow-right"></i></>}
                        </button>
                    </form>
