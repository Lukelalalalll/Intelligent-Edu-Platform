...
export default function Step2Extract({ states, handlers }) {
    ...
    const { setExtractPrompt, setApiType, extractContent, toggleExercise, toggleAllExercises, clearExerciseSelection, takeSingleScreenshot, takeBatchScreenshots } = handlers;
