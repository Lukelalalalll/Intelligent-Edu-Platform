...
const PptGeneratorMode = ({
                ...
                <div className="space-y-4">
                    {selectedWebProvider.value === "auto" && (
                        <div className="rounded-lg border border-[#D9D6FE] bg-[#F4F3FF] p-3 text-xs leading-5 text-[#5146E5]">
                            PPT Generator will use model-native web grounding when available. If the selected text model does not support it, web search stays off until you choose an external provider.
                        </div>
                    )}
    ...
    return (
        <div className='w-full max-w-[660px] font-syne pb-10'>
            <p className='px-2.5 py-0.5 w-fit text-[#7A5AF8] rounded-[50px]  border border-[#EDEEEF] text-[10px] font-medium mb-5 font-syne'>PPT Generator</p>
            <div className=''>
                ...
                <p className='text-[#000000CC] text-xl font-normal font-syne'>
                    {providerStep === 1
                        ...
                        : providerStep === 2
                            ? "Choose how PPT Generator creates visuals, or continue without image generation."
...
export default PptGeneratorMode
