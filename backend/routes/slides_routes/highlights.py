...
from backend.services.slides.pipeline_service import load_highlights as _load_highlights_impl
from backend.services.slides.pipeline_service import save_highlights as _save_highlights_impl

logger = logging.getLogger(__name__)
router = APIRouter()


@router.post("/save_highlights")
...
@router.get("/load_highlights/{filename}")
